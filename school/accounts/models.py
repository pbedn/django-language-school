...
class Teacher(models.Model):
    ...
    date_of_birth = models.DateField(blank=True, null=True)
    basic_course_rate = models.DecimalField(blank=True, null=True, max_digits=10, decimal_places=2)
    basic_individual_lesson_rate = models.DecimalField(blank=True, null=True, max_digits=10, decimal_places=2)
